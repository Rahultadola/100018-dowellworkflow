...
from .views import editor, workflow_delete_view, workflow_update_view, create_document_type, getDocumentTypeObject, WorkFlowListView, DocumentCreatedListView, DocumentWorkFlowAddView, DocumentExecutionListView, DocumentVerificationView


app_name = 'workflow'

urlpatterns = [
    path('editor/', login_required(editor)),
